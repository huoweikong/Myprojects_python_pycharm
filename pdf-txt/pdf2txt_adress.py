        ...
        for page in doc.get_pages(): # doc.get_pages() 获取page列表
            ...
            for x in layout:
                if (isinstance(x, LTTextBoxHorizontal)):
                    #/ Users / aiqiangyun / Documents / 2

                    with open(r'/Users/aiqiangyun/Documents/2txt/%s.txt'%to_txt, 'a') as f:
                        results = x.get_text()
                        #print(results)
                        f.write(results + '\n')
def clearhuanhang():
    file3 = open('/Users/aiqiangyun/Documents/2txt/%s.txt' % to_txt, 'r', encoding='utf-8')
    file4 = open('/Users/aiqiangyun/Documents/2txt/%s4.txt' % to_txt, 'w')
    try:
